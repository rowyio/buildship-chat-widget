...
<div id="buildship-chat-widget__header">
  <div id="buildship-chat-widget__title">
    <svg
      id="buildship-chat-widget__title_icon"
      width="24"
      height="19"
      viewBox="0 0 24 19"
    >
    ...
    <!-- Widget title text will be placed here -->
  </div>

  <div>
    <a
      id="buildship-chat-widget__branding"
      href="https://buildship.com"
      target="_blank"
      rel="noopener"
      >Powered by&nbsp;<span>BuildShip</span></a
    >
  </div>
</div>
<div id="buildship-chat-widget__body">
  <!-- The messages_history div will be placed here. -->
  <form id="buildship-chat-widget__form">
    <input
      autocomplete="off"
    ...
    <button id="buildship-chat-widget__submit" type="submit">
      <svg width="14" height="14" viewBox="0 0 16 14" fill="none">
        <path
          d="M1 7L15 7M15 7L9 13M15 7L9 1"
          stroke="white"
          stroke-width="2"
